...
class TensorflowService {
  ...
  StreamController<Uint8List> _imageController = StreamController();
  Stream get classiferController => this._classiferController.stream;
  Stream get imageController => this._imageController.stream;
    ...
    if (_isSavedImage) {
      try {
        ...
        if (_imageController.isClosed) {
          _imageController = new StreamController();
        }
